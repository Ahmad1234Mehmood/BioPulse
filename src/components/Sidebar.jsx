    ...
    <aside className={wrapperClass}>
      ...
      <div className="px-6 mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-indigo-500 font-bold leading-tight">Biometrics Core</div>
      ...
      <div className="px-3 mt-auto space-y-4">
        ...
        <div className="px-3 space-y-1">
          <a href="#" className="flex items-center gap-3 px-3 py-2 text-slate-400 hover:bg-white/5 hover:text-slate-100 rounded-lg transition-all text-xs">
